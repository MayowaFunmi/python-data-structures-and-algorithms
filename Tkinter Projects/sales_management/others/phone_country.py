...
code = phone_country("2348187669362")
country_details = pycountry.countries.get(alpha_2=code)
print(code)
...
class Location_Tracker:
    def __init__(self, App):
        ...
        self.country_label = Label(App, text="display country", fg="white", font=("Times", 20), bg="#3f5efb")
